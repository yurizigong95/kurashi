...
function scriptableCode(){
  return [
    ...
    '    const a = w.addText(l2 ? String(soon.length) : "–"); a.font = Font.boldSystemFont(22); a.centerAlignText();',
    ...
    '    const b = w.addText(!l2 ? (d ? "締切は新しい版で出ます" : "読みこめませんでした") : soon.length ? "締切3日以内 " + soon.length + "件：" + soon[0].t : "3日以内の締切なし"); b.font = Font.systemFont(11); b.lineLimit = 1;',
    '  }',
    '} else {',
